...
export const metadata = {
  title: "Player Search | FPL Hauls",
  description: "Search Fantasy Premier League players and analyze data science prediction models and expected distributions.",
};
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 border-b border-slate-200/80 pb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Data science expected points distributions, fixture difficulty ratings (FDR), floor, ceiling, and haul likelihood.
        </p>
      </div>
